...
const mostrarMaisAlura = document.querySelector(".projetos__botao--mostrar-mais--alura");
let contadorAlura = 1;

mostrarMaisAlura.addEventListener("click", function() {
    const projetosAlura = document.querySelectorAll(".mostrar-mais--alura");
...
const mostrarMaisProprios = document.querySelector(".projetos__botao--mostrar-mais--proprios");
let contadorProprios = 1;

mostrarMaisProprios.addEventListener("click", function() {
    const projetosProprios = document.querySelectorAll(".mostrar-mais--proprios");
